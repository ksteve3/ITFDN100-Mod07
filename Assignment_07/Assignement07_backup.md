...
# <icon>![image alt text](image_0.png)[Exception Handling in Python ](#heading=h.1t3h5sf)

# <icon>![image alt text](image_1.png)[Pickling in Python ](#heading=h.3mzq4wv)
...
##### Video Tutorial Reference: [26],  *[Python Tutorial: Using Try/Except Blocks for Error Handlin*g](https://www.youtube.com/watch?v=NIWwJbo-9_8)[86] (external link), Timestamp: 00:50 ![image alt text](image_2.png)<icon>

*Download the Sample Code from GitHub !* ![image alt text](image_3.png)<icon>
...
*Table 1: Get the Code - GitHub Snippet Repository contributed by **[CoreyMSchafe*r](https://github.com/CoreyMSchafer)* *(external link)
...
##### <TODO>"C:\Users\kstev\Desktop\Snips 2\Exception Handling\7.1\7.1_Listing-1.txt"
...
##### <TODO>"C:\Users\kstev\Desktop\Snips 2\Exception Handling\7.2\7.2_Listing-7.txt"
...
##### <TODO>"C:\Users\kstev\Desktop\Snips 2\Exception Handling\7.3\7.3_Listing-10.txt"
...
##### #TODO<replace>"C:\Users\kstev\Desktop\Snips 2\Pickle\2.1\2.1 - Listing 16 .txt"
...
Video Tutorial Reference: [95] ![image alt text](image_19.png)<icon>
...
# 2.4 Input:
 ...
 #TODO<replace>"C:\Users\kstev\Desktop\Snips 2\Pickle\2.4\2.4a - Listing 23 .txt"
...
#TODO<replace>"C:\Users\kstev\Desktop\Snips 2\Pickle\2.4\2.4b - Listing 25.txt"
...
<icon>![image alt text](image_22.png)For more control over serialization and de-serialization, Pickler or an Unpickler objects are created, respectively.
...
*#TODO<replace>**"C:\Users\kstev\Desktop\Snips 2\Pickle\2.5\2.5 pickling and scaling.txt"*
